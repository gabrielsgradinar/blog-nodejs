...
//Configurações
  ...
  // Middleware
    app.use((req, res, next) => {
        ...
        res.locals.user = req.user || null; //armazena as informações do usuario autenticado
        next()
    });
  ...
  //Public 
    app.use(express.static(path.join(__dirname,"public"))); //diz em qual pasta está todos os arquivos estáticos
